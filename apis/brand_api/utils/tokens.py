...
def create_access_token(subject: str | Any, expires_delta: int = None) -> str:
    if expires_delta is not None:
        ...
        expires_delta = datetime.utcnow() + timedelta(minutes=os.environ["ACCESS_TOKEN_EXPIRE_MINUTES"])
...
def create_refresh_token(subject: str | Any, expires_delta: int = None) -> str:
    if expires_delta is not None:
        ...
        expires_delta = datetime.utcnow() + timedelta(minutes=os.environ["REFRESH_TOKEN_EXPIRE_MINUTES"])
