...
Revision ID: 0003
Revises: 0002
Create Date: 2023-01-24 20:13:23.768430
...
def upgrade() -> None:
    ...
    op.create_foreign_key("users_id", "brands", "users", ["deleted_by"], ["id"])
    op.create_foreign_key("users_id", "brands", "users", ["updated_by"], ["id"])
    op.create_foreign_key("users_id", "brands", "users", ["created_by"], ["id"])
    ...
    op.create_foreign_key("users_id", "categories", "users", ["created_by"], ["id"])
    op.create_foreign_key("users_id", "categories", "users", ["deleted_by"], ["id"])
    op.create_foreign_key("users_id", "categories", "users", ["updated_by"], ["id"])
    ...
    op.create_foreign_key("users_id", "users", "users", ["updated_by"], ["id"])
    op.create_foreign_key("users_id", "users", "users", ["deleted_by"], ["id"])
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("users_id", "users", type_="foreignkey")
    op.drop_constraint("users_id", "users", type_="foreignkey")
    ...
    op.drop_constraint("users_id", "categories", type_="foreignkey")
    op.drop_constraint("users_id", "categories", type_="foreignkey")
    op.drop_constraint("users_id", "categories", type_="foreignkey")
    ...
    op.drop_constraint("users_id", "brands", type_="foreignkey")
    op.drop_constraint("users_id", "brands", type_="foreignkey")
    op.drop_constraint("users_id", "brands", type_="foreignkey")
