...
Revision ID: 0003
Revises: 0002
Create Date: 2023-01-24 19:57:20.581073
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, "brands", "users", ["updated_by"], ["id"])
    op.create_foreign_key(None, "brands", "users", ["deleted_by"], ["id"])
    op.create_foreign_key(None, "brands", "users", ["created_by"], ["id"])
...
def downgrade() -> None:
    ...
    op.drop_constraint("", "categories", type_="foreignkey")
    op.drop_constraint("", "categories", type_="foreignkey")
    op.drop_constraint("", "categories", type_="foreignkey")
    ...
    op.drop_constraint("", "brands", type_="foreignkey")
    op.drop_constraint("", "brands", type_="foreignkey")
    op.drop_constraint("", "brands", type_="foreignkey")
